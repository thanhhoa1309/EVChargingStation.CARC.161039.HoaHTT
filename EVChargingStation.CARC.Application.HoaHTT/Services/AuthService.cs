...
namespace EVChargingStation.CARC.Application.HoaHTT.Services
{
    public class AuthService : IAuthService
    {
        ...
        /// <returns></returns>
        public async Task<LoginResponceDto> LoginAsync(LoginRequestDto loginDto, IConfiguration configuration)
        {
        ...
        public async Task<LoginResponceDto?> RefreshTokenAsync(TokenRefreshRequestDto refreshTokenDto, IConfiguration configuration)
        {
