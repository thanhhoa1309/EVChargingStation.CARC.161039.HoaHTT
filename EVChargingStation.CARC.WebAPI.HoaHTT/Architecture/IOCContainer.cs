...
using EVChargingStation.CARC.Application.HoaHTT.Services;
using EVChargingStation.CARC.Application.HoaHTT.Services.Commons;
using EVChargingStation.CARC.Domain.HoaHTT;
using EVChargingStation.CARC.Infrastructure.Commons;
using EVChargingStation.CARC.Infrastructure.HoaHTT;
using EVChargingStation.CARC.Infrastructure.HoaHTT.Commons;
using EVChargingStation.CARC.Infrastructure.HoaHTT.Interfaces;
using EVChargingStation.CARC.Infrastructure.HoaHTT.Repositories;
...
namespace EVChargingStation.CARC.WebAPI.HoaHTT.Architecture;
...
public static class IocContainer
{
    ...
    private static IServiceCollection SetupDbContext(this IServiceCollection services)
    {
        ...
        services.AddDbContext<FA25_SWD392_SE161039_G6_EvChargingStation>(options =>
            options.UseNpgsql(connectionString,
                sql => sql.MigrationsAssembly(typeof(FA25_SWD392_SE161039_G6_EvChargingStation).Assembly.FullName)
            )
        );
